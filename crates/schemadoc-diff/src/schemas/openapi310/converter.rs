...
use crate::schemas::openapi310::context::*;
...
impl From<OpenApi310> for core::HttpSchema {
    fn from(spec: OpenApi310) -> Self {
        ...
        core::HttpSchema {
            ...
            schema_source: OpenApi310::id().to_owned(),
...
fn convert_paths(
    paths: IndexMap<String, MayBeRef310<Path>>,
...
fn merge_parameters(
    context: &ConvertContext,
    parameters_refs: Option<Vec<MayBeRef310<Parameter>>>,
    path_parameters_refs: &Option<Vec<MayBeRef310<Parameter>>>,
) -> Vec<MayBeRef310<Parameter>> {
    let mut parameters: Vec<MayBeRef310<Parameter>> = Vec::new();
...
fn convert_operation(
    operation: Operation,
    path_parameters: &Option<Vec<MayBeRef310<Parameter>>>,
    context: &ConvertContext,
) -> core::Operation {
...
fn convert_request_body_ref(
    request_body_ref: MayBeRef310<RequestBody>,
...
fn convert_headers(
    headers: IndexMap<String, MayBeRef310<Header>>,
...
fn convert_link(link: Link) -> core::Link {
    core::Link {
        ...
        server: link.server.map(convert_server),
    }
}

fn convert_examples(
    examples: IndexMap<String, MayBeRef310<Example>>,
...
fn convert_example_values(
    examples: IndexMap<String, MayBeRef310<Value>>,
...
fn convert_security_scheme_ref(
    security_scheme_ref: MayBeRef310<SecurityScheme>,
